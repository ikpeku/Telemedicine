        ...
        <Splash onLayout={onLayoutRootView}>
            <ScrollView style={styles.container} >
                ...
                <View style={styles.splashPhotoContainer}>
                    <Image source={require('../assets/splash2.png')} style={styles.splashPhoto} resizeMode="contain" />
                </View>
                ...
                <View style={styles.titleContainer}>
                    ...
                    <Text style={styles.text}>Go through a consultation to determine if you have the illness</Text>
                </View>

                <View >
                    <Pressable onPress={() => router.push("onboarding3")} style={styles.splashBtnContainer}>
